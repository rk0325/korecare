...
ActiveRecord::Schema[7.0].define(version: 20_240_317_175_320) do
  ...
  create_table 'favorite_cosmetics', force: :cascade do |t|
    ...
    t.datetime 'updated_at', null: false
    t.string 'item_code'
    t.index %w[user_id item_code], name: 'index_favorite_cosmetics_on_user_id_and_item_code', unique: true
