      ...
      <Carousel className="mx-auto w-4/5 md:w-1/2 max-w-screen-xl shadow-md">
        <CarouselContent>
          <CarouselItem>
            <Card className='carousel-height-custom flex flex-col items-center justify-center'>
              <CardContent className="flex flex-col items-center justify-center p-2">
                <p className="text-text-color text-center text-lg">KoreCareでできること</p>
          ...
          <CarouselItem>
            <Card className='carousel-height-custom flex flex-col items-center justify-center'>
              <CardContent className="flex flex-col items-center justify-center p-2">
                <p className="text-text-color text-center p-4 text-lg">韓国コスメが人気の理由は？</p>
                <Image src="/coming_soon.png" alt="Image" width={300} height={300} />
              </CardContent>
            </Card>
          </CarouselItem>
          <CarouselItem>
            <Card className='carousel-height-custom flex flex-col items-center justify-center'>
              <CardContent className="flex flex-col items-center justify-center p-2">
                <p className="text-text-color text-center p-4 text-lg">韓国コスメを購入・使用する際の注意点</p>
                <Image src="/coming_soon.png" alt="Image" width={300} height={300} />
              </CardContent>
            </Card>
          </CarouselItem>
