  ...
  return (
    <>
      ...
      <div>
        ...
        <p className='pt-2'>（1）<a href="https://liff.line.me/1645278921-kWRPP32q/?accountId=577suiot" target="_blank" rel="noopener noreferrer" className="underline">こちら</a>から、KoreCare公式アカウントを友だちへ追加</p>
        <p className='pt-2'>（2）「紫外線 / 乾燥注意通知」の場合はお住まいを設定、「使用期限通知」の場合は製品タイプ・開封日・使用期限を設定（3アイテムまで設定できます）</p>
